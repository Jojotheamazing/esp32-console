...
extern int osd_load_file(const char *path, void *data, int len);
extern int osd_save_file(const char *path, const void *data, int len);
...
void nes_launch_game(const char* filepath, bool enable_sound,int volume);
void nes_stop_game(void);
void nes_set_volume(int volume);
